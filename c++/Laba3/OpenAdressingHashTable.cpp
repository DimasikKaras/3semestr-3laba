...
OpenAddressingHashTable::OpenAddressingHashTableNode::OpenAddressingHashTableNode(string& k, string& value) : key(
        std::move(k)), data(std::move(value)), isDelete(false), isNull(false) {}
